...
const Blog = ({datum}) => {
    ...
    return (
        <div className='pt-5 space-y-5 border-b py-8'>
          <div>
             <img src={blog_cover_img} className='rounded-lg' alt="" />
          </div>
          <div>
             <div className='flex  justify-between'>
                <div className='flex gap-3 items-center'>
                  <img src={author_img} width="70px" className='rounded-full' alt="" />
                  <div>
                    <h3 className='text-base font-bold lg:text-lg'>{author_name}</h3>
                    <p className='text-xs lg:text-md'>{posted_date}</p>
                  </div>
               </div>
                       <p className='text-xs lg:text-base flex justify-center items-center gap-2'>
                           {read_time} minutes read  <button><FaBookmark></FaBookmark></button>
                       </p>
             ...
             <div className='flex gap-3'>
              {
                ...
                className='text-amber-700 text-xs lg:text-base' key={id}># {tag}</p>)
              }
             </div>
          </div>
        </div>
